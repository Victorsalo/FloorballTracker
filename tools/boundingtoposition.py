...
# Punkter i planet for att calibrera homografi
...
def undistort(videopath, calibration_matrix_yaml, output_name):
    ...
    while True:
        ...
        if frame_number % 20 == 0:
            print(f"{frame_number}/{total_frame_number}")
